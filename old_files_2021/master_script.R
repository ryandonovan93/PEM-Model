...
df <- read.csv("/Users/ryandonovan 1/Desktop/PEM_2021_Data_Analysis/Data_Analysis/pem_data_2023/df")
...
write_xlsx(df.spearman_self_report_r, "output/correlation_matrix_self_report_R_values_personality.xlsx")
write_xlsx(df.spearman_self_report_P, "output/correlation_matrix_self_report_P_values_personality.xlsx")
...
#Nonlinear = Disgust Reaction, Disgust Baseline + Joy Baseline


OTE_lm_MIA <- lm(Openness_to_Experience ~ Disgust_reaction + Disgust_baseline + Joy_baseline, data = data)
OTE_gam_MIA <- gam(Openness_to_Experience ~ s(as.numeric(Disgust_reaction), k = 4) + s(as.numeric(Disgust_baseline), k = 4) + s(as.numeric(Joy_baseline), k = 4), data = data)
...
gam.vcomp(Intellect_MIA_gam,rescale=TRUE,conf.lev=.95)
...
gam.vcomp(Openness_SRO_gam,rescale=TRUE,conf.lev=.95)
...
Conscientiousness_SRO_lm <- lm(Conscientiousness ~ Sadness_baseline + Joy_reaction + Fear_baseline, data = data)
Conscientiousness_SRO_gam <- gam(Conscientiousness ~ s(Sadness_baseline, k = 4)+ s(Joy_reaction, k = 4) + s(Fear_baseline, k = 4), data = data)
...
Extraversion_SRO_lm <- lm(Extraversion ~ Joy_baseline + Joy_reaction + Disgust_reaction, data = data)
Extraversion_SRO_gam <- gam(Extraversion ~ s(Joy_baseline, k = 4)+ s(Joy_reaction, k = 4) + s(Disgust_reaction), data = data)
...
pcor.test(df$Conscientiousness,df$Sadness_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Industriousness,df$Sadness_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Orderliness,df$Sadness_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")


pcor.test(df$Conscientiousness,df$Anger_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Industriousness,df$Anger_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Orderliness,df$Anger_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")

pcor.test(df$Industriousness,df$Anger_baseline, df$Neuroticism, method ="spearman")
pcor.test(df$Industriousness,df$Anger_baseline, df$Volatility, method ="spearman")
pcor.test(df$Industriousness,df$Anger_baseline, df$Withdrawal, method ="spearman")
pcor.test(df$Industriousness,df$Anger_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")


pcor.test(df$Conscientiousness,df$Fear_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Industriousness,df$Fear_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Orderliness,df$Fear_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")


pcor.test(df$Agreeableness,df$Fear_reaction,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Compassion,df$Fear_reaction,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Politeness,df$Fear_reaction,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")


pcor.test(df$Assertiveness,df$Fear_baseline,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
pcor.test(df$Enthusiasm,df$Fear_reaction,c(df$Neuroticism, df$Volatility, df$Withdrawal), method ="spearman")
